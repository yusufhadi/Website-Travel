                    ...
                    <div class="container">
                       <div class="row">
                            ...
                            <div class="col-md-8 text-center">
                                <img src="frontend/images/partner.png" alt="Logo Parnert" class="img-partner">
                            </div>
                       </div>
                    </div>
                </section>
                            ...
                            <div class="col-sm-6 col-md-6 col-lg-4">
                                <div class="card card-testimonial text-center">
                                    <div class="testimonial-content">
                                        <img src="frontend/images/hadi.png" alt="user" class="mb-4 rounded-circle">
                                        <h3 class="mb-4">Hadi Yusuf</h3>
                                        <p class="testimonial">
                                            "It was glorious and i cloud not stop to 
                                            say wohooo for every single moment Dankeeee"
                                        </p>
                                    </div>
                                    <hr>
                            ...
                            <div class="col-sm-6 col-md-6 col-lg-4">
                                <div class="card card-testimonial text-center">
                                    <div class="testimonial-content">
                                        ...
                                        <p class="testimonial">
                                            "The trip was amazing and i saw Something Beatiful
