                ...
                <div class="row">
                        ...
                        <div class="card card-details">
                                                ...
                                                <td class="align-middle">
                                                    @if ($item->details->count() > 1)
                                                        ...
                                                        <a href="{{ route('checkout-remove', $detail->id) }}">
                                                            <img src="{{ url('../frontend/images/ic-del.png') }}" alt="">
                                                        </a>
                                                    @endif
                                                </td>
                                            </tr>
                            ...
                            <div class="member mt-3">
                                ...
                                <form class="form-inline" method="POST"
                                    ...
                                    <label name="nationality" for="nationality" class="sr-only">Nationality</label>
                                    <input type="text" class="form-control mb-2 mr-sm-2" style="width: 50px"
                                        id="nationality" placeholder="NA">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="join-container">
                            <a href="{{ route('checkout-succes', $item->id) }}"
